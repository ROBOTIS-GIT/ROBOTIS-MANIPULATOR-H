...
void DemoModule::initialize(const int control_cycle_msec, robotis_framework::Robot *robot)
{
  ...
  kinematics_pose_msg_pub_ = _ros_node.advertise<manipulator_h_demo_module_msgs::KinematicsPose>("/robotis/demo/kinematics_pose_msg", 5, true );
...
void DemoModule::IniPoseMsgCallback( const std_msgs::String::ConstPtr& msg )
{
  ...
  if ( Robotis->is_moving == false )
  {
    ...
    {
      // parse initial pose
      std::string _ini_pose_path = ros::package::getPath("manipulator_h_demo_module") + "/config/ini_pose.yaml";
...
bool DemoModule::GetJointPoseCallback( manipulator_h_demo_module_msgs::GetJointPose::Request &req , manipulator_h_demo_module_msgs::GetJointPose::Response &res )
{
  if ( enable_ == false )
    return false;
...
bool DemoModule::GetKinematicsPoseCallback( manipulator_h_demo_module_msgs::GetKinematicsPose::Request &req , manipulator_h_demo_module_msgs::GetKinematicsPose::Response &res )
{
  if ( enable_ == false )
    return false;
...
void DemoModule::KinematicsPoseMsgCallback( const manipulator_h_demo_module_msgs::KinematicsPose::ConstPtr& msg )
{
  //    ROS_INFO("1");
...
void DemoModule::JointPoseMsgCallback( const manipulator_h_demo_module_msgs::JointPose::ConstPtr& msg )
{
...
void DemoModule::RobotisDemoMsgCallback( const manipulator_h_demo_module_msgs::RobotisDemo::ConstPtr& msg )
{
  if ( Robotis->is_moving == false )
  {
