...
#include "moveit_state.h"

#include "manipulator_h_demo_module_msgs/JointPose.h"
#include "manipulator_h_demo_module_msgs/KinematicsPose.h"
#include "manipulator_h_demo_module_msgs/RobotisDemo.h"

#include "manipulator_h_demo_module_msgs/GetJointPose.h"
#include "manipulator_h_demo_module_msgs/GetKinematicsPose.h"
...
public:
  ...
  void    JointPoseMsgCallback( const manipulator_h_demo_module_msgs::JointPose::ConstPtr& msg );
  void    KinematicsPoseMsgCallback( const manipulator_h_demo_module_msgs::KinematicsPose::ConstPtr& msg );

  void    ExecutePlannedPathCallback( const std_msgs::String::ConstPtr& msg );

  bool    GetJointPoseCallback( manipulator_h_demo_module_msgs::GetJointPose::Request &req , manipulator_h_demo_module_msgs::GetJointPose::Response &res );
  bool    GetKinematicsPoseCallback( manipulator_h_demo_module_msgs::GetKinematicsPose::Request &req , manipulator_h_demo_module_msgs::GetKinematicsPose::Response &res );

  void    DisplayPlannedPathCallback( const moveit_msgs::DisplayTrajectory::ConstPtr& msg );

  void    RobotisDemoMsgCallback( const manipulator_h_demo_module_msgs::RobotisDemo::ConstPtr& msg );
  void    SendDemoEndMsg();
