...
public:
	...
	**********************/
    ...
    void sendJointPoseMsg( manipulator_h_demo_module_msgs::JointPose msg );
    void sendKinematicsPoseMsg( manipulator_h_demo_module_msgs::KinematicsPose msg );
...
Q_SIGNALS:
    ...
    void update_curr_joint_pose( manipulator_h_demo_module_msgs::JointPose );
    void update_curr_kinematics_pose( manipulator_h_demo_module_msgs::KinematicsPose );
