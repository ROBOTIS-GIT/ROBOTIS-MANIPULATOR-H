    ...
    , qnode(argc,argv)
{
    ...
    ****************************/
    ...
    QObject::connect(&qnode, SIGNAL(update_curr_joint_pose(manipulator_h_base_module_msgs::JointPose)), this, SLOT(update_curr_joint_pose_spinbox(manipulator_h_base_module_msgs::JointPose)));

    qRegisterMetaType<manipulator_h_base_module_msgs::KinematicsPose>("manipulator_h_base_module_msgs::KinematicsPose");
    QObject::connect(&qnode, SIGNAL(update_curr_kinematics_pose(manipulator_h_base_module_msgs::KinematicsPose)), this, SLOT(update_curr_kinematics_pose_spinbox(manipulator_h_base_module_msgs::KinematicsPose)));
...
void MainWindow::update_curr_joint_pose_spinbox( manipulator_h_base_module_msgs::JointPose msg )
{
...
void MainWindow::update_curr_kinematics_pose_spinbox( manipulator_h_base_module_msgs::KinematicsPose msg )
{
