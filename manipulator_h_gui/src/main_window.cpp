...
#include <QMessageBox>
#include <iostream>
#include "../include/manipulator_h_gui/main_window.hpp"
  ...
  , qnode(argc,argv)
{
  ...
  qRegisterMetaType<manipulator_h_demo_module_msgs::JointPose>("manipulator_h_demo_module_msgs::JointPose");
  QObject::connect(&qnode, SIGNAL(update_curr_joint_pose(manipulator_h_demo_module_msgs::JointPose)), this, SLOT(update_curr_joint_pose_spinbox(manipulator_h_demo_module_msgs::JointPose)));

  qRegisterMetaType<manipulator_h_demo_module_msgs::KinematicsPose>("manipulator_h_demo_module_msgs::KinematicsPose");
  QObject::connect(&qnode, SIGNAL(update_curr_kinematics_pose(manipulator_h_demo_module_msgs::KinematicsPose)), this, SLOT(update_curr_kinematics_pose_spinbox(manipulator_h_demo_module_msgs::KinematicsPose)));
...
{
  manipulator_h_demo_module_msgs::JointPose msg;
...
{
  manipulator_h_demo_module_msgs::KinematicsPose msg;
...
void MainWindow::update_curr_kinematics_pose_spinbox( manipulator_h_demo_module_msgs::KinematicsPose msg )
{
