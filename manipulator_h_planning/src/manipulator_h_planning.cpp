...
{
  static moveit::planning_interface::MoveGroupInterface group("arm");
...
void kinematics_pose_msg_callback( const manipulator_h_demo_module_msgs::KinematicsPose::ConstPtr& msg )
{
