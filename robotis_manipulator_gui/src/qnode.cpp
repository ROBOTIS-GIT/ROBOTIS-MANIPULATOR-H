...
bool QNode::init() {
  ...
  n.getParam("/robotis_manipulator_gui/ar_1_x_offset", ar_1_x_offset);
  n.getParam("/robotis_manipulator_gui/ar_1_y_offset", ar_1_y_offset);
  n.getParam("/robotis_manipulator_gui/ar_2_x_offset", ar_2_x_offset);
  n.getParam("/robotis_manipulator_gui/ar_2_y_offset", ar_2_y_offset);
  ...
  joint_pose_msg_pub = n.advertise<manipulator_demo_module_msgs::JointPose>("/robotis/demo/joint_pose_msg", 0);
  kinematics_pose_msg_pub = n.advertise<manipulator_demo_module_msgs::KinematicsPose>("/robotis/demo/kinematics_pose_msg", 0);

  execute_planned_path_msg_pub = n.advertise<std_msgs::String>("/robotis/demo/execute_planned_path", 0);

  robotis_demo_msg_pub = n.advertise<manipulator_demo_module_msgs::RobotisDemo>("/robotis/demo/robotis_demo_msg", 10, true);
  ...
  get_joint_pose_client = n.serviceClient<manipulator_demo_module_msgs::GetJointPose>("/robotis/demo/get_joint_pose", 0);
  get_kinematics_pose_client = n.serviceClient<manipulator_demo_module_msgs::GetKinematicsPose>("/robotis/demo/get_kinematics_pose", 0);
...
void QNode::run() {
  ...
  while ( ros::ok() )
  {
    ...
    if ( send_ar_1_pose == true )
    {
      ...
      {
        get_ar_pose = false;
        manipulator_demo_module_msgs::RobotisDemo robotis_demo_msg;
...
void QNode::sendJointPoseMsg( manipulator_demo_module_msgs::JointPose msg )
{
...
void QNode::sendKinematicsPoseMsg( manipulator_demo_module_msgs::KinematicsPose msg )
{
...
void QNode::getJointPose( std::vector<std::string> joint_name )
{
  ...
  manipulator_demo_module_msgs::GetJointPose _get_joint_pose;
  ...
  {
    manipulator_demo_module_msgs::JointPose _joint_pose;
...
void QNode::getKinematicsPose ( std::string group_name )
{
  ...
  manipulator_demo_module_msgs::GetKinematicsPose _get_kinematics_pose;
  ...
  {
    manipulator_demo_module_msgs::KinematicsPose _kinematcis_pose;
