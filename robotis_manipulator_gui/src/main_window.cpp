  ...
  , qnode(argc,argv)
{
  ...
  joint_spinbox.append( ui.grip_spinbox );

  /****************************
    ** Connect
    ****************************/

  qRegisterMetaType<manipulator_demo_module_msgs::JointPose>("manipulator_demo_module_msgs::JointPose");
  QObject::connect(&qnode, SIGNAL(update_curr_joint_pose(manipulator_demo_module_msgs::JointPose)), this, SLOT(update_curr_joint_pose_spinbox(manipulator_demo_module_msgs::JointPose)));

  qRegisterMetaType<manipulator_demo_module_msgs::KinematicsPose>("manipulator_demo_module_msgs::KinematicsPose");
  QObject::connect(&qnode, SIGNAL(update_curr_kinematics_pose(manipulator_demo_module_msgs::KinematicsPose)), this, SLOT(update_curr_kinematics_pose_spinbox(manipulator_demo_module_msgs::KinematicsPose)));
...
{
  manipulator_demo_module_msgs::JointPose msg;
...
{
  manipulator_demo_module_msgs::KinematicsPose msg;
...
//void MainWindow::on_exe_button_clicked( bool check )
//{
//    std_msgs::String msg;

//    msg.data ="execute";

//    qnode.sendExecuteMsg( msg );
//}
...
void MainWindow::on_set_mode_button_clicked( bool check )
{
  ...
  msg.data ="demo_module";

  qnode.sendSetModeMsg( msg );
}

void MainWindow::on_demo_start_button_clicked( bool check )
{
  qnode.is_demo_running = true;

  qnode.demo_name.data = "1_go_ini_pose";

  qnode.ar_id = 0;
  qnode.half_cycle = false;

  qnode.send_ar_pose = false;
  qnode.get_ar_pose = false;
  qnode.get_ar_1_pose = false;
  qnode.get_ar_2_pose = false;

  qnode.sendRobotisDemoMsg( qnode.demo_name );
}

void MainWindow::on_demo_stop_button_clicked( bool check )
{
  if ( qnode.is_demo_running == true )
  {
    qnode.is_demo_running = false;
    qnode.demo_name.data = "";
  }
}
...
void MainWindow::update_curr_joint_pose_spinbox( manipulator_demo_module_msgs::JointPose msg )
{
...
void MainWindow::update_curr_kinematics_pose_spinbox( manipulator_demo_module_msgs::KinematicsPose msg )
{
